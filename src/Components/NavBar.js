...
import profile1 from './undraw_profile_1.svg'
import profile2 from './undraw_profile_2.svg'
import profile3 from './undraw_profile_3.svg'
...
export default function NavBar() {
    ...
    const alerts =[
        ...
        },
        {
            ...
            alertmsg : "$290.29 has been deposited into your account!"
        
        },
        {
            type : "warning",
            date : "December 2, 2019",
            alertmsg : "Spending Alert: We've noticed unusually high spending for your account."
        }
    ]
                    ...
                    <ul className="navbar-nav ml-auto">
                            ...
                            <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
...

                                {
                                    ...
                                    <div>
                                        ...
                                        <span className="font-weight-bold">{alert.alertmsg}</span>
                                    </div>
                                </a>
                                        )
                                    })
                            ...
                            <div className="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
...

                                {
                                    ...
                                    <div className="dropdown-list-image mr-3">
                                        <img className="rounded-circle" src={msg.source}
                                            alt="..." />
                                        <div class="status-indicator bg-success"></div>
                                    </div>
                                    <div className="font-weight-bold">
                                        <div className="text-truncate">{msg.message}</div>
                                        <div className="small text-gray-500">{msg.nameTime}</div>
                                    </div>
                                </a>
                        ...
                        <li className="nav-item dropdown no-arrow">
                            <a className="nav-link dropdown-toggle" href="/" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span className="mr-2 d-none d-lg-inline text-gray-600 small">Piyush Vyas</span>
